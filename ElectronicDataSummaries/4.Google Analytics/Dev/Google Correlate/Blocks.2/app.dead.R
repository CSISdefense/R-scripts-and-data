...
# read in data            
FullData <- read.csv("Google 1.csv")
...
updateSelectizeInput(session, "Type", choices = Type, 
                     selected = "Commentary", server = TRUE)
