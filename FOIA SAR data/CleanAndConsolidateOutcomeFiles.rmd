...
JSFschedule$SARbaselineDevEst<-as.Date(JSFschedule$SARbaselineDevEst)
JSFschedule$CurrentAPBobjective<-as.Date(JSFschedule$CurrentAPBobjective)
JSFschedule$CurrentAPBthreshold<-as.Date(JSFschedule$CurrentAPBthreshold)
JSFschedule$CurrentEstimate<-as.Date(JSFschedule$CurrentEstimate)
